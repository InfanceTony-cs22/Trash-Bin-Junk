elif elif operation == 'multiply    result = multiply(operand1, operand2)
...
if operation == 'add':
    if operation == 'add':
    result = add(operand1, operand2)    result = multiply(operand1, operand2)
elif operation == 'divide':
ltiply':
    result = multiply(operand1, operand2)
elif operation == 'divide':
if operation == 'add': == 'multiply    result = multiply(operand1, operand2)
elif operation == 'divide':
ltiply':
    result = multiply(operand1, operand2)
elif operation == 'divide':
...
if operation == 'add':elif operation == 'multiply    result = multiply(operand1, operand2)
elif operation == 'divide':
ltiply':
    result = multiply(operand1, operand2)
elif operation == 'divide':
...
if operation == 'add':
    ...
    result = subtract(operand1, operand2)operand1 = float(sys.argv[2])
    result = add(operand1, operand2)
elif operation == 'subtract':
    result = subtract(operand1, operand2)
...
if operation == 'add':
    ...
    result =
    result = add(operand1, operand2)
elif operation == 'subtract':if operation == 'add':
if operation == 'add':
    if operation == 'add':
    result = add(operand1, operand2)
elif operation == 'subtract':
...
if __name__ == "__main__":print("traveling to madurai")
...
if __name__ == "__main__":operand1 = float(sys.argv[2])
operand2 = float(sys.argv[3])
